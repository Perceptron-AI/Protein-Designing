import os, time, gzip, json, urllib
...
cath_nr40_file = '/content/drive/MyDrive/Protein Data/cath/' + cath_nr40_fn
...
cath_domain_file = '/content/drive/MyDrive/Protein Data/cath/cath-domain-list.txt'
download_cached(cath_domain_url, cath_domain_file)

cache_dir = '/content/drive/MyDrive/Protein Data/cath/mmtf/'
...
for chain_ix, (pdb, chain) in enumerate(chain_set):
    try:
        ...
        start = time.time()
        chain_dict = mmtf_parse(pdb, chain, cache_dir)
...
outfile = '/content/drive/MyDrive/Protein Data/cath/chain_set.jsonl'
