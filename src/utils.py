...
def get_args():
    ...
    parser.add_argument('--file_data', type=str, default='/content/drive/MyDrive/Protein Data/chain_set.jsonl', help='input chain file')
    parser.add_argument('--file_splits', type=str, default='/content/drive/MyDrive/Protein Data/chain_set_splits.json', help='input chain file')
